...
[![npm](https://img.shields.io/npm/v/@unigetSystemInfoSync.svg)](https://www.npmjs.com/package/@unigetSystemInfoSync)
...
export default () => (
  <iframe style={{
      ...
      width: '375px',
      height: '700px'
    }} src='https://herbox.online/p/109000004/app_1aKtEd7SK?previewZoom=100&view=preview&defaultPage=pages/getsysteminfosync/index&topSlider=false'></iframe>
);
```
