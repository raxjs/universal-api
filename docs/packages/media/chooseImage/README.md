...
[![npm](https://img.shields.io/npm/v/@unichooseImage.svg)](https://www.npmjs.com/package/@unichooseImage)
...
```bash
$ npm install @uni/chooseImage --save
```
or
```bash
...
```javascript
import chooseImage from '@uni/chooseImage';
...
export default () => (
  <iframe style={{
      ...
      width: '375px',
      height: '700px'
    }} src='https://herbox.online/p/109000004/app_1aKtEd7SK?previewZoom=100&view=preview&defaultPage=pages/choose-image/index&topSlider=false'></iframe>
);
```
