...
[![npm](https://img.shields.io/npm/v/@uni/apis.svg)](https://www.npmjs.com/package/@uni/apis) [![npm](https://img.shields.io/npm/v/@uni/compress-image.svg)](https://www.npmjs.com/package/@uni/compress-image)
...
你也可以从大包引入：
```js
import { compressImage } from '@uni/apis';
```
...
export default () => (
  <iframe style={{
      ...
      width: '375px',
      height: '700px'
    }} src='https://herbox-embed.alipay.com/p/uni/uni?previewZoom=100&view=preview&defaultPage=pages/compress-image/index&topSlider=false'></iframe>
);
```
