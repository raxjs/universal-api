...
export default () => (
  <iframe style={{
      ...
      width: '375px',
      height: '700px'
    }} src='https://herbox.online/p/109000004/app_ZalJy1DSm?previewZoom=100&view=preview&defaultPage=pages/universal-getsysteminfosync/index&topSlider=false'></iframe>
);
```
