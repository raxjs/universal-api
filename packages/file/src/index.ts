...
export const upload = (options: UploadOptions) => {
  if (isWeChatMiniProgram) {
    ...
    throw new Error('universal-api：file.upload暂不支持');
  }
};
export const download = (options: DownloadOptions) => {
  if (isWeChatMiniProgram) {
    ...
    throw new Error('universal-api：file.download暂不支持');
  }
};
export const getInfo = (options: GetInfoOptions) => {
  if (isWeChatMiniProgram) {
    ...
    throw new Error('universal-api：file.getInfo暂不支持');
  }
};
export const getSavedInfo = (options: GetSavedInfoOptions) => {
  if (isWeChatMiniProgram) {
    ...
    throw new Error('universal-api：file.getSavedInfo暂不支持');
  }
};
export const getSavedList = (options: GetSavedListOptions) => {
  if (isWeChatMiniProgram) {
    ...
    throw new Error('universal-api：file.getSavedList暂不支持');
  }
};
export const save = (options: SaveOptions) => {
  if (isWeChatMiniProgram) {
    ...
    throw new Error('universal-api：file.save暂不支持');
  }
};
export const removeSaved = (options: RemoveSavedOptions) => {
  if (isWeChatMiniProgram) {
    ...
    throw new Error('universal-api：file.removeSaved暂不支持');
  }
};
export const openDocument = (options: OpenDocumentOptions) => {
  if (isWeChatMiniProgram) {
    ...
    throw new Error('universal-api：file.openDocument暂不支持');
  }
};
let res: IFile;
if (isWeChatMiniProgram) {
  ...
  throw new Error('universal-api：file暂不支持');
}
export default res;