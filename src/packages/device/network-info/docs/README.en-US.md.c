...
# @uni/network[![npm](https://img.shields.io/npm/v/@uni/network.svg)](https://www.npmjs.com/package/@uni/network)
...
```js
import Network from '@uni/network';
