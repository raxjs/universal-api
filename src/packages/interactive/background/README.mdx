...
# @uni/background [![npm](https://img.shields.io/npm/v/@uni/background.svg)](https://www.npmjs.com/package/@uni/background)
...
```bash
$ npm install @uni/background --save
```
...
```js
import Background from '@uni/background';
